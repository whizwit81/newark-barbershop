...
import {
  getAppointmentById,
  updateAppointment,
} from "../Services/ScheduledApptService.jsx";
...
export const EditDropDownAppointment = ({ currentUser }) => {
  ...
  const submitUpdatedAppointment = () => {
    ...
    updateAppointment(whateverMyHeartDesires).then(() => {
      navigate(`/newAppointment/${updatedAppt}`);
    });
  };
